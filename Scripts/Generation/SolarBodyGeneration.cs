...
public class SolarBodyGeneration {
	...
	public static Mesh GetTorusMesh (){
	...
	public static Mesh GetTubeMesh (){
	...
	public static Mesh GetConeMesh (){
		...
		float topRadius = .05f;//0.0f // pyramid
		int nbSides = 18;//4 // pyramid
